package studies.studiesgenerator;
...
public class S3StudiesGenerator {

    private static final Logger LOG = LoggerFactory.getLogger(S3StudiesGenerator.class);
    ...
    public static void putRandomData(Studies studies) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Studies> studiesArrayList = new ArrayList<>();
        studiesArrayList.add(new Studies(UUID.randomUUID().toString(), "mouse", "os x", "eu-west-1"));
        studiesArrayList.add(new Studies(UUID.randomUUID().toString(), "keyboard", "windows", "eu-west-2"));
        studiesArrayList.add(new Studies(UUID.randomUUID().toString(), "mouse", "ubuntu", "eu-west-1"));
        studiesArrayList.add(new Studies(UUID.randomUUID().toString(), "camera", "os x", "eu-west-2"));
